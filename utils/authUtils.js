...
const userDataValidation = ({ name, email, username, password }) => {
  return new Promise((resolve, reject) => {
    ...
    if (!isEmailValidate({ key: email })) reject("Email format is not valid");
    resolve();
  });
};
...
const sendEmailVerificationMail = (email, token) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: "Email Verification for Blogging App",
    html: `<head>
                ...
                <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                    ...
                    <tr>
                      ...
                      <a href="http://localhost:8000/auth/verify/${token}" style=" border: none;
...
module.exports = { userDataValidation, generateJwt, sendEmailVerificationMail };
